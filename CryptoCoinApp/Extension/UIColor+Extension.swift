...
extension UIColor {
    ...
    static let secondaryBackgroundColor = UIColor(red: 243/255.0, green: 244/255.0, blue: 246/255.0, alpha: 1)
    ...
    static let lowerBackColor = UIColor(red: 229/255.0, green: 240/255.0, blue: 255/255.0, alpha: 1)
}
